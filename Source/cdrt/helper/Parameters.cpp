...
juce::AudioProcessorValueTreeState::ParameterLayout createLayout(void)
{
    ...
    parameters.push_back (std::make_unique<juce::AudioParameterFloat> (juce::ParameterID {"dry", 5}, "Dry", juce::NormalisableRange<float> {0.0, 1.0f, 0.01f}, 0.7f));
    parameters.push_back (std::make_unique<juce::AudioParameterFloat> (juce::ParameterID {"wet", 6}, "Wet", juce::NormalisableRange<float> {0.0, 1.0f, 0.01f}, 0.7f));
